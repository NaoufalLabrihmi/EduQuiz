...
export default function QuizCreator({ courseId, onComplete, onFormChange, submitting, initialValues }: QuizCreatorProps) {
  ...
  // Call onFormChange with the current quiz data
              ...
              <Card key={questionIndex} className="border-dashed bg-white/90 shadow-md rounded-xl animate-fade-in-fast transition-all duration-300">
                <CardHeader className="py-3 px-4 flex flex-row items-center justify-between">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    onClick={() => { removeQuestion(questionIndex); emitFormChange(); }}
                ...
                <CardContent className="space-y-4">
                  <div className="mb-4">
                    ...
                    <Textarea
                      ...
                      value={question.text}
                      onChange={(e) => { handleQuestionChange(questionIndex, "text", e.target.value); emitFormChange(); }}
                      placeholder=""
                      rows={2}
                      required
                      disabled={submitting}
                    ...
                    {question.options?.map((option, optionIndex) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() => { setCorrectOption(questionIndex, optionIndex); emitFormChange(); }}
                          ...
                          <div className="flex-1">
                            ...
                            <Input
                              ...
                              value={option}
                              onChange={(e) => { handleOptionChange(questionIndex, optionIndex, e.target.value); emitFormChange(); }}
                              placeholder=""
                              required
                              disabled={submitting}
